# EasyFlightWall
This project is a DIY Flight Display Panel, inspired by the original FlightWall concept created by aviation enthusiasts and makers who combine real-time flight data with LED matrix displays.
